...
from app.schemas.role_permission import RolePermissionCreate, RolePermissionUpdate,RolePermissionOut
...
@router.post("/assign", response_model=ResponseModel[RolePermissionOut], dependencies=[Depends(require_permission("role_permissions.assign"))])
...
@router.post("/deassign", response_model=ResponseModel[RolePermissionOut], dependencies=[Depends(require_permission("role_permissions.deassign"))])
